...
export const MARITAL_STATUS = `${MASTERS}/marital-status`;
export const COURSE_STATUS = `${MASTERS}/course-status`;
export const RELATION_STATUS = `${MASTERS}/relation-status`;
export const LEAVE_STATUS = `${MASTERS}/leave-status`;
